...
**Next:** WU-5 migrate `CanonicalDurableRunCoordinatorTest` to the fixture (the high-density, 22-construction-site slice per chick's risk call-out; preserve identical RunOutcome shape and event-ordering).
