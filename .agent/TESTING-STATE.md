...
**WU-3 in progress (lock acquired 2026-09-09T06:30Z):** spawn `sddk-apply` worker for the `EchoDurableSpineTest` migration; do NOT re-run WU-2 evidence (already green at `e6ea8d9d` + `9f05c04c...`).
