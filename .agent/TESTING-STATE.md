...
**Next:** S2.5.7 WU-3 — `ExecutionBoundaryFactory.build(...)` (use `FamilyRouter.decide(...)` ADT to build the production boundary; the factory is what the spine, Main, and the recording tests will route through).
