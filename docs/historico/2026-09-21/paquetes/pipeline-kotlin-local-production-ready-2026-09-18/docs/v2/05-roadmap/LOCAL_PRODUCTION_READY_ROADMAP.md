...
LPR-5 Observation UX + agentic inspection
  ↓
LPR-6 local-core certification + real projects        ← LOCAL-CORE-V1-CERTIFICATION = GREEN (2026-09-18, SHA 12088c54: 16 steps / 15 SUPPORTED_CERTIFIED / 1 EXPERIMENTAL / 0 SUPPORTED_NOT_CERTIFIED; profile frozen — no growth before first release except critical defects)
  ↓
...
LPR-9 dogfooding + hardening
  ↓
LPR-GATE-1 LOCAL_PRODUCTION_READY                    ← NOT YET CLOSED: entering distribution certification phase (WU-LPR-105 event-spine race, then WU-091/062/063/064/070/071/080/LPR-9)
  ↓
