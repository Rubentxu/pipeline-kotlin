...
| UAT-RP-023 | COVERED (RP-5) | `WU_RP_040_RECEIPT.md` (R3.1 SBOM + R3.2 secret-scan) + receipts individuales CI: SBOM CycloneDX job verde (49 componentes en `bom.json/xml`, sha256=`223f65d2...8cd1` y `7d261bb9...6b77`); gitleaks CI job verde con allowlist `.gitleaks.toml` documentada. **KNOWN_GAP documentado:** SAST (detekt/pushdoor) NO implementado (R3.3); dependency-audit (Dependabot/dependency-check) NO implementado (R3.4) — pendientes para WU-RP-040 R5. |
