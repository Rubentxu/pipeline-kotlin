...
**Update 2026-09-24 (dogfood parcial):** UAT-RP-024 evidencia parcial 1-repo emitida (`UAT_RP_024_PARTIAL_DOGFOOD_RECEIPT.md`, binario rc3 sobre src reales del motor: exit 0, 453 archivos inventariados, artefacto producido, replay memoized mismo --db/--control-root exit 0, sandbox aisló escape `../`). Sigue PARCIAL (≥2 repos, NO COVERED). Hallazgo colateral: shutdown race 1/3 (hilo no-daemon sqlite-event-writer retiene DestroyJavaVM), deuda nueva prioridad baja.
