...
| `core.file.writeFile` | CORE | REGISTRY_PRIMARY | CERTIFIED + LEGACY_REMOVED | CERTIFIED | [G8](S2_A3_CORE_WRITEFILE_G8_FINAL_CINAL_CERTIFICATION_RECEIPT.md) | 17 | `WORKSPACE_OPERATIONS_CAPABILITY` |
