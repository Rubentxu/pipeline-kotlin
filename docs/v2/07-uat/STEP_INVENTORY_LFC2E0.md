...
CERTIFIED + EXTERNAL_REFERENCE total: 20
YAML entries total: 23  (12 + 8 external + 2 + 1; load is documented as REJECTED for historical traceability)
```
