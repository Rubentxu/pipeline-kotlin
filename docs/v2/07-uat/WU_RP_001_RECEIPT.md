...
head_sha: 7fd407ef827cb4ea47339b8ba76277a55841d95f (this WU does not change source; head is WU-RP-000 tip)
source_tree_sha: 7fd407ef827cb4ea47339b8ba76277a55841d95f
...
remote_ci:
  ...
  conclusion: failure
  jobs:
    compile: SUCCESS (path fix VERIFIED at 5aa31802)
    domain-unit: FAILURE (1 pre-existing flake)
    architecture-fitness: FAILURE (2 pre-existing drifts)
...
checks:
  ...
  - id: release-reference-existing
    ...
    evidence: v0.39.0 "pipelinek 0.39.0 — Local Production Ready (LPR-GATE-1)" published
              ...
              HEAD 7fd407ef is NOT a release; CERTIFICATION_PROTOCOL §4 CHANNEL-GATE
...
risks_residual:
  ...
  - R2: HEAD = 7fd407ef is NOT yet pushed again — this WU changes nothing in tree.
