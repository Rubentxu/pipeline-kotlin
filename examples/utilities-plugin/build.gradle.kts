...
group = "pipeline.utilities.json"
version = "1.0.0"

// INDEPENDENT BUILD (LFC-2E2 first OFFICIAL_PLUGIN, FASE 6 of the SDDK cycle).
//
// This is the first plugin shipped against the frozen universal-core authoring
// surface established by LFC-2E2-PREP. It depends ONLY on the public SDK
// artifacts (pipeline-domain: StepDefinitionContributor/StepRegistry contracts
// + domain value types; pipeline-scripting-api: the DSL facade surface). It
// does NOT import any application/runtime internal package.
//
...
tasks.jar {
    ...
    // descriptor is a resource; the SDK contracts come from the host at runtime.
}
