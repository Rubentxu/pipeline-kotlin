package dev.rubentxu.pipeline.core
...
class PipelineContext() : IPipelineContext {
    ...
    private val eventStore: IEventStore = EventStore()
    ...
    override fun injectEnvironmentVariables(envVars: Map<String, String>) {
//        val envs = steps.env
//        envVars.forEach { (k, v) -> envs[k] = v }
