...
data class KubernetesConfig(
    ...
    companion object : PipelineComponentFromMapFactory<KubernetesConfig> {
        override fun create(data: Map<String, Any>): KubernetesConfig {
...
data class Template(
    ...
    companion object : PipelineComponentFromMapFactory<Template> {
        override fun create(data: Map<String, Any>): Template {
            val volumesMap: List<Map<String, Any>> = data.validateAndGet("volumes")
                .isList()
                .defaultValueIfInvalid(emptyList<Map<String, Any>>()) as List<Map<String, Any>>

            val volumes: List<Volume> = volumesMap.map {
                return@map Volume.create(it)
            }
            ...
            val containers: List<Container> = containersMap.map {
                return@map Container.create(it)
            }
            ...
            val imagePullSecrets: List<ImagePullSecret> = imagePullSecretsMap.map {
                return@map ImagePullSecret.create(it)
            }
...
data class Volume(
    ...
    companion object : PipelineComponentFromMapFactory<Volume> {
        override fun create(data: Map<String, Any>): Volume {
            ...
            return Volume(
                hostPathVolume = HostPathVolume.create(hostPathVolumeMap),
                emptyDirVolume = EmptyDirVolume.create(emptyDirVolumeMap),
                configMapVolume = ConfigMapVolume.create(configMapVolumeMap)
            )
        }
    }
}
...
data class HostPathVolume(
    ...
    companion object : PipelineComponentFromMapFactory<HostPathVolume> {
...
data class EmptyDirVolume(
    ...
    companion object : PipelineComponentFromMapFactory<EmptyDirVolume> {
...
data class ConfigMapVolume(
    ...
    companion object : PipelineComponentFromMapFactory<ConfigMapVolume> {
...
data class Container(
    ...
    companion object : PipelineComponentFromMapFactory<Container> {
...
data class ImagePullSecret(
    ...
    companion object : PipelineComponentFromMapFactory<ImagePullSecret> {
