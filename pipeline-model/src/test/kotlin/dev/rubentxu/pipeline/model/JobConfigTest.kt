...
class JobConfigTest : StringSpec({
    "Should get Job Config from the job config file" {
        ...
        config.jobs?.get(0)?.publisher?.archiveArtifacts?.artifacts shouldBe "target/*.jar"
        config.jobs?.get(0)?.jobParameters?.size shouldBe 5
        config.jobs?.get(0)?.jobParameters?.get(0)?.shouldBeInstanceOf<StringJobParameter>()
        config.jobs?.get(0)?.jobParameters?.get(0)?.name shouldBe "FOO"
        config.jobs?.get(0)?.jobParameters?.get(0)?.defaultValue shouldBe "BAR"
        config.jobs?.get(0)?.jobParameters?.get(0)?.description shouldBe "FOO BAR"
        config.jobs?.get(0)?.jobParameters?.get(1)?.shouldBeInstanceOf<ChoiceJobParameter>()
        config.jobs?.get(0)?.jobParameters?.get(1)?.name shouldBe "BAZ"
        (config.jobs?.get(0)?.jobParameters?.get(1) as ChoiceJobParameter)?.choices shouldBe listOf("1", "2")
        config.jobs?.get(0)?.jobParameters?.get(2)?.shouldBeInstanceOf<BooleanJobParameter>()
        config.jobs?.get(0)?.jobParameters?.get(2)?.name shouldBe "QUX"
        config.jobs?.get(0)?.jobParameters?.get(2)?.defaultValue shouldBe true
        config.jobs?.get(0)?.jobParameters?.get(2)?.description shouldBe "QUX"
        config.jobs?.get(0)?.jobParameters?.get(3)?.shouldBeInstanceOf<PasswordJobParameter>()
        config.jobs?.get(0)?.jobParameters?.get(3)?.name shouldBe "QUUX"
        config.jobs?.get(0)?.jobParameters?.get(3)?.defaultValue shouldBe "QUUX"
        config.jobs?.get(0)?.jobParameters?.get(3)?.description shouldBe "QUUX"
        config.jobs?.get(0)?.jobParameters?.get(4)?.shouldBeInstanceOf<TextJobParameter>()
        config.jobs?.get(0)?.jobParameters?.get(4)?.name shouldBe "CORGE"
        config.jobs?.get(0)?.jobParameters?.get(4)?.defaultValue shouldBe "CORGE"
        config.jobs?.get(0)?.jobParameters?.get(4)?.description shouldBe "CORGE"
        ...
        config.jobs?.get(0)?.pipelineFileSource?.shouldBeInstanceOf<AbstractPipelineLoader>()
    ...
    "Should validate required fields in Job Config" {
        ...
        config.jobs?.forEach { job ->
            ...
            job.jobParameters.shouldNotBeEmpty()
    ...
    "Should validate field types in Job Config" {
        ...
        config.jobs?.forEach { job ->
            ...
            job.jobParameters.forEach { it.shouldBeInstanceOf<JobParameter>() }
            job.projectSource.shouldBeTypeOf<ProjectSource>()
            job.librarySources.forEach { it.shouldBeInstanceOf<LibrarySource>() }
            job.pipelineFileSource.shouldBeTypeOf<AbstractPipelineLoader>()
        }
    }
})