...
class CoreIsUnixRegistryPrimaryFitnessTest {
    ...
    @Disabled("Historical S2-A10/G4 snapshot: S2-B10/G5 (2026-09-13) physically removed core.archiveArtifacts; the 3-key count is superseded by `G5 LEGACY_REMOVED post-S2-B10-G5 - core dot isUnix stays absent`. Preserved verbatim for traceability.")
    @Test
    ...
    @Disabled("Historical S2-A10/G5 snapshot: S2-B10/G5 (2026-09-13) physically removed core.archiveArtifacts; the 3-key count is superseded by `G5 LEGACY_REMOVED post-S2-B10-G5 - core dot isUnix stays absent`. Preserved verbatim for traceability.")
    @Test
