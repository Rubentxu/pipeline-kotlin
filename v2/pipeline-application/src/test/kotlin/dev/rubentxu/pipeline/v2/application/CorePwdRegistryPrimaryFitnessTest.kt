...
class CorePwdRegistryPrimaryFitnessTest {
    ...
    @Test
    fun `G5 LEGACY_REMOVED post-S2-B10-G5 - core dot pwd stays absent`() {
        assertTrue(
            key.value !in CanonicalCoreStepCommand.LEGACY_PLUGIN_IDS,
            "core.pwd MUST remain absent from LEGACY_PLUGIN_IDS post-S2-B10/G5 LEGACY_REMOVED of core.archiveArtifacts",
        )
        assertEquals(
            2,
            CanonicalCoreStepCommand.LEGACY_PLUGIN_IDS.size,
