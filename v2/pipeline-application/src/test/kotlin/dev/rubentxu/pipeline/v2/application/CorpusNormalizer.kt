...
object CorpusNormalizer {
    ...
    fun normalizeEvent(event: DomainEvent): Map<String, Any?> {
        ...
        when (event) {
            is dev.rubentxu.pipeline.v2.events.RunStarted -> {
                map["runId"] = null
                map["occurredAt"] = null
            }
            is dev.rubentxu.pipeline.v2.events.RunFinished -> {
                map["runId"] = null
                map["occurredAt"] = null
            }
            is dev.rubentxu.pipeline.v2.events.StageStarted -> {
                map["eventId"] = null
                map["runId"] = null
                map["occurredAt"] = null
            ...
            is dev.rubentxu.pipeline.v2.events.StageFinished -> {
                map["eventId"] = null
                map["runId"] = null
                map["occurredAt"] = null
                map["stageIndex"] = event.stageIndex
            ...
            is dev.rubentxu.pipeline.v2.events.StepStarted -> {
                map["eventId"] = null
                map["runId"] = null
                map["occurredAt"] = null
            ...
            is dev.rubentxu.pipeline.v2.events.StepFinished -> {
                map["eventId"] = null
                map["runId"] = null
                map["occurredAt"] = null
                map["stepIndex"] = event.stepIndex
            ...
            is dev.rubentxu.pipeline.v2.events.EchoOutputCaptured -> {
                map["eventId"] = null
                map["runId"] = null
                map["occurredAt"] = null
                map["content"] = event.content
            }
            is dev.rubentxu.pipeline.v2.events.StepFailed -> {
                map["eventId"] = null
                map["runId"] = null
                map["occurredAt"] = null
