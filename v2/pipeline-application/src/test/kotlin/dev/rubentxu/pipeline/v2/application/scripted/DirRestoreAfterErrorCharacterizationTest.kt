...
class DirRestoreAfterErrorCharacterizationTest {
    ...
    @org.junit.jupiter.api.Disabled(
        "WIDE-GAP: pipeline continuation after dir(...) failure. Documented at " +
            "docs/v2/07-uat/HAR_007_DIR_RESTORE_CHARACTERIZATION.md; CLI-level " +
            "evidence lives in the same receipt. Re-enable on GREEN of the " +
            "dir.failureMode ADT / try-finally isolation slice.",
    )
