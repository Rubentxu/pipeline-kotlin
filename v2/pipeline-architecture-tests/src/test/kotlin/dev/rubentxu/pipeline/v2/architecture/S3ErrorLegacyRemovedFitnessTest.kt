 ...
 *   `{core.cleanWs, core.load, core.waitUntil, core.archiveArtifacts}` (4
 *   entries; `core.milestone` flipped REGISTRY_PRIMARY at S2-A8/G4 and its
 *   legacy forms are physically present but UNREACHABLE until G5).
 *
 * State at G6 close:
 *   REGISTERED          = true
