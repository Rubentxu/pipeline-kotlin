...
/**
 * Public StepKey for `core-utils.readYaml` (LFC-2E2 utilities OFFICIAL_PLUGIN).
 *
 ...
 */
object CoreUtilsReadYamlKey {
    val VALUE: PluginStepId = PluginStepId("core-utils.readYaml")
}
